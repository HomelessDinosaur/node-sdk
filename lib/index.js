...
var require_faas_pb = __commonJS({
  "src/gen/proto/faas/v1/faas_pb.js"(exports) {
    ...
    proto.nitric.faas.v1.BucketNotificationConfig.deserializeBinaryFromReader = function(msg, reader) {
      while (reader.nextField()) {
        ...
        switch (field) {
          case 1:
            var value = (
              /** @type {!proto.nitric.faas.v1.BucketNotificationType} */
              reader.readEnum()
            );
    ...
    proto.nitric.faas.v1.WebsocketWorker.deserializeBinaryFromReader = function(msg, reader) {
      while (reader.nextField()) {
        ...
        switch (field) {
          ...
          case 2:
            var value = (
              /** @type {!proto.nitric.faas.v1.WebsocketEvent} */
              reader.readEnum()
            );
            msg.setEvent(value);
            break;
    ...
    proto.nitric.faas.v1.InitRequest.prototype.getWebsocket = function() {
      return (
        /** @type{?proto.nitric.faas.v1.WebsocketWorker} */
    ...
    proto.nitric.faas.v1.InitRequest.prototype.clearWebsocket = function() {
      return this.setWebsocket(void 0);
    };
    ...
    proto.nitric.faas.v1.InitRequest.prototype.getHttpWorker = function() {
      return (
        /** @type{?proto.nitric.faas.v1.HttpWorker} */
    ...
    proto.nitric.faas.v1.InitRequest.prototype.clearHttpWorker = function() {
      return this.setHttpWorker(void 0);
    };
    ...
    proto.nitric.faas.v1.TriggerRequest.prototype.getWebsocket = function() {
      return (
        /** @type{?proto.nitric.faas.v1.WebsocketTriggerContext} */
    ...
    proto.nitric.faas.v1.NotificationTriggerContext.prototype.getNotificationCase = function() {
      return (
        /** @type {proto.nitric.faas.v1.NotificationTriggerContext.NotificationCase} */
        jspb.Message.computeOneofCase(this, proto.nitric.faas.v1.NotificationTriggerContext.oneofGroups_[0])
      );
    };
    if (jspb.Message.GENERATE_TO_OBJECT) {
    ...
    proto.nitric.faas.v1.NotificationTriggerContext.prototype.getBucket = function() {
      return (
        /** @type{?proto.nitric.faas.v1.BucketNotification} */
    ...
    proto.nitric.faas.v1.TriggerResponse.prototype.getWebsocket = function() {
      return (
        /** @type{?proto.nitric.faas.v1.WebsocketResponseContext} */
...
var require_resource_pb = __commonJS({
  "src/gen/proto/resource/v1/resource_pb.js"(exports) {
    ...
    goog.exportSymbol("proto.nitric.resource.v1.WebsocketResourceDetails", null, global);
    ...
    proto.nitric.resource.v1.WebsocketResourceDetails = function(opt_data) {
      jspb.Message.initialize(this, opt_data, 0, -1, null, null);
    };
    goog.inherits(proto.nitric.resource.v1.WebsocketResourceDetails, jspb.Message);
    if (goog.DEBUG && !COMPILED) {
      proto.nitric.resource.v1.WebsocketResourceDetails.displayName = "proto.nitric.resource.v1.WebsocketResourceDetails";
    }
    ...
    if (jspb.Message.GENERATE_TO_OBJECT) {
      proto.nitric.resource.v1.WebsocketResourceDetails.prototype.toObject = function(opt_includeInstance) {
        return proto.nitric.resource.v1.WebsocketResourceDetails.toObject(opt_includeInstance, this);
      };
      proto.nitric.resource.v1.WebsocketResourceDetails.toObject = function(includeInstance, msg) {
        var f, obj = {
          url: jspb.Message.getFieldWithDefault(msg, 1, "")
        };
        if (includeInstance) {
    ...
    proto.nitric.resource.v1.WebsocketResourceDetails.deserializeBinary = function(bytes) {
      var reader = new jspb.BinaryReader(bytes);
      var msg = new proto.nitric.resource.v1.WebsocketResourceDetails();
      return proto.nitric.resource.v1.WebsocketResourceDetails.deserializeBinaryFromReader(msg, reader);
    };
    proto.nitric.resource.v1.WebsocketResourceDetails.deserializeBinaryFromReader = function(msg, reader) {
      while (reader.nextField()) {
        if (reader.isEndGroup()) {
          break;
        }
    ...
    proto.nitric.resource.v1.WebsocketResourceDetails.prototype.serializeBinary = function() {
      var writer = new jspb.BinaryWriter();
      proto.nitric.resource.v1.WebsocketResourceDetails.serializeBinaryToWriter(this, writer);
      return writer.getResultBuffer();
    };
    proto.nitric.resource.v1.WebsocketResourceDetails.serializeBinaryToWriter = function(message, writer) {
      var f = void 0;
      f = message.getUrl();
      if (f.length > 0) {
        writer.writeString(
    ...
    proto.nitric.resource.v1.WebsocketResourceDetails.prototype.getUrl = function() {
      return (
        /** @type {string} */
        jspb.Message.getFieldWithDefault(this, 1, "")
      );
    };
    proto.nitric.resource.v1.WebsocketResourceDetails.prototype.setUrl = function(value) {
      return jspb.Message.setProto3StringField(this, 1, value);
    };
    if (jspb.Message.GENERATE_TO_OBJECT) {
    ...
    proto.nitric.resource.v1.ResourceDetailsResponse.oneofGroups_ = [[10, 11]];
    ...
    if (jspb.Message.GENERATE_TO_OBJECT) {
      ...
      proto.nitric.resource.v1.ResourceDetailsResponse.toObject = function(includeInstance, msg) {
        var f, obj = {
          ...
          websocket: (f = msg.getWebsocket()) && proto.nitric.resource.v1.WebsocketResourceDetails.toObject(includeInstance, f)
        };
        if (includeInstance) {
          obj.$jspbMessageInstance = msg;
        }
      ...
      while (reader.nextField()) {
        ...
        switch (field) {
          ...
          case 10:
            ...
            break;
          case 11:
            var value = new proto.nitric.resource.v1.WebsocketResourceDetails();
            reader.readMessage(value, proto.nitric.resource.v1.WebsocketResourceDetails.deserializeBinaryFromReader);
            msg.setWebsocket(value);
            break;
          default:
            reader.skipField();
    ...
    proto.nitric.resource.v1.ResourceDetailsResponse.serializeBinaryToWriter = function(message, writer) {
      ...
      if (f != null) {
        writer.writeMessage(
          11,
          f,
          proto.nitric.resource.v1.WebsocketResourceDetails.serializeBinaryToWriter
        );
      }
    };
    ...
    proto.nitric.resource.v1.ResourceDetailsResponse.prototype.getWebsocket = function() {
      return (
        /** @type{?proto.nitric.resource.v1.WebsocketResourceDetails} */
        jspb.Message.getWrapperField(this, proto.nitric.resource.v1.WebsocketResourceDetails, 11)
      );
    };
    proto.nitric.resource.v1.ResourceDetailsResponse.prototype.setWebsocket = function(value) {
      return jspb.Message.setOneofWrapperField(this, 11, proto.nitric.resource.v1.ResourceDetailsResponse.oneofGroups_[0], value);
    };
    proto.nitric.resource.v1.ResourceDetailsResponse.prototype.clearWebsocket = function() {
      return this.setWebsocket(void 0);
    };
    proto.nitric.resource.v1.ResourceDetailsResponse.prototype.hasWebsocket = function() {
      return jspb.Message.getField(this, 11) != null;
    };
...
__export(src_exports, {
  Api: () => Api,
  ApiWorkerOptions: () => ApiWorkerOptions2,
  Bucket: () => Bucket2,
  BucketNotification: () => BucketNotification,
  BucketNotificationWorkerOptions: () => BucketNotificationWorkerOptions2,
  ...
  NitricEvent: () => NitricEvent,
  NitricTask: () => NitricTask,
  Queue: () => Queue,
  ...
  Secrets: () => Secrets,
  Storage: () => Storage,
  SubscriptionWorkerOptions: () => SubscriptionWorkerOptions2,
  Topic: () => Topic,
...
// src/types.ts
var NitricEvent = class {
  constructor(payload, id, payloadType) {
    this.payload = payload;
    this.id = id;
    this.payloadType = payloadType || "none";
  }
};
var NitricTask = class {
  constructor({
    id = void 0,
    payload,
    payloadType = "none"
...
var Topic = class {
  ...
  publish(_0) {
    return __async(this, arguments, function* (event2, opts = DEFAULT_PUBLISH_OPTS) {
      const nitricEvent = event2 instanceof NitricEvent ? event2 : new NitricEvent(event2);
      ...
      evt.setPayload(import_struct_pb.Struct.fromJavaScript(nitricEvent.payload));
  ...
  send(tasks) {
    return __async(this, null, function* () {
      return new Promise((resolve, reject) => {
        ...
        const nitricTasksArray = tasksArray.map(
          (t) => t instanceof NitricTask ? t : new NitricTask({ payload: t })
        );
...
var ReceivedTask = class extends NitricTask {
  constructor({
    id,
    leaseId,
    payload,
...
__export(faas_exports, {
  ...
  BucketNotificationType: () => BucketNotificationType,
  EventContext: () => EventContext,
  EventRequest: () => EventRequest,
  Faas: () => Faas,
  FaasWorkerOptions: () => FaasWorkerOptions,
  FileNotificationContext: () => FileNotificationContext,
  FileNotificationRequest: () => FileNotificationRequest,
...
var TriggerContext = class {
  ...
  static fromGrpcTriggerRequest(trigger, options) {
    if (trigger.hasHttp()) {
...
var HttpContext = class extends TriggerContext {
  ...
  static fromGrpcTriggerRequest(trigger, options) {
    const http3 = trigger.getHttp();
    const ctx = new HttpContext();
    const headers = http3.getHeadersMap().getEntryList().reduce(
      (acc, [key, [val]]) => __spreadProps(__spreadValues({}, acc), {
        [key.toLowerCase()]: val.length === 1 ? val[0] : val
      }),
      {}
    );
    const query = http3.getQueryParamsMap().getEntryList().reduce(
      (acc, [key, [val]]) => __spreadProps(__spreadValues({}, acc), {
        [key]: val.length === 1 ? decodeURIComponent(val[0]) : val.map((v) => decodeURIComponent(v))
      }),
      {}
    );
    const params = http3.getPathParamsMap().getEntryList().reduce(
      (acc, [key, val]) => __spreadProps(__spreadValues({}, acc), {
        [key]: val.length === 1 ? val[0] : val
      }),
      {}
    );
    const oldQuery = http3.getQueryParamsOldMap().toArray().reduce(
      (acc, [key, val]) => __spreadProps(__spreadValues({}, acc), {
        [key]: decodeURIComponent(val)
      }),
      {}
    );
    const oldHeaders = http3.getHeadersOldMap().toArray().reduce(
      (acc, [key, val]) => __spreadProps(__spreadValues({}, acc), {
        [key]: val
      }),
      {}
...
var BucketNotificationType = /* @__PURE__ */ ((BucketNotificationType3) => {
  BucketNotificationType3[BucketNotificationType3["Created"] = 0] = "Created";
  BucketNotificationType3[BucketNotificationType3["Deleted"] = 1] = "Deleted";
  return BucketNotificationType3;
})(BucketNotificationType || {});
var BucketNotificationRequest = class extends AbstractRequest {
  constructor(data, traceContext, key, notificationType) {
    super(data, traceContext);
    this.eventTypeToNotificationType = (eventType) => {
      switch (eventType) {
        case import_faas_pb.BucketNotificationType.CREATED:
          return 0 /* Created */;
        case import_faas_pb.BucketNotificationType.DELETED:
          return 1 /* Deleted */;
        default:
...
var FileNotificationContext = class extends TriggerContext {
  get bucketNotification() {
    return this;
  }
  static fromGrpcTriggerRequest(trigger, options) {
...
var FileNotificationRequest = class extends BucketNotificationRequest {
  constructor(data, traceContext, key, notificationType, bucket3) {
    super(data, traceContext, key, notificationType);
    this.file = bucket3.file(key);
  }
};
...
var http = (app, callback) => {
  ...
  if (Number.isNaN(port)) {
    ...
    import_portfinder.default.getPort((err, port2) => {
      ...
      new HttpWorker(nodeApp, port2, callback);
    });
    return;
  }
...
var Faas = class {
  ...
  start(...handlers) {
    return __async(this, null, function* () {
      ...
      if (!(this.options instanceof HttpWorkerOptions) && !this.httpHandler && !this.eventHandler && !this.bucketNotificationHandler && !this.anyHandler) {
      ...
      if (this.options instanceof HttpWorkerOptions && process.env.NITRIC_ENVIRONMENT !== "build") {
      ...
      if (this.options instanceof ApiWorkerOptions2) {
        ...
        initRequest.setSchedule(scheduleWorker);
      } else if (this.options instanceof SubscriptionWorkerOptions2) {
      ...
      } else if (this.options instanceof BucketNotificationWorkerOptions2) {
        ...
        const httpWorker = new import_faas_pb2.HttpWorker();
...
var http2 = (...handlers) => getFaasInstance().http(...handlers);
...
var Method = class {
  constructor(route, methods, opts, ...middleware) {
    ...
    this.methods = methods;
    this.faas = new Faas(
      new ApiWorkerOptions2(route.api.name, route.path, methods, opts)
    );
...
var Route = class {
  constructor(api3, path2, options = {}) {
    this.api = api3;
    this.path = path2;
...
var SubscriptionWorkerOptions2 = class {
  constructor(topic2) {
    this.topic = topic2;
  }
};
var Subscription = class {
  constructor(name, ...middleware) {
    this.faas = new Faas(new SubscriptionWorkerOptions2(name));
...
var import_faas_pb3 = __toESM(require_faas_pb());
var everything2 = ["reading", "writing", "deleting"];
var BucketNotificationWorkerOptions2 = class {
  constructor(bucket3, notificationType, notificationPrefixFilter) {
    this.bucket = bucket3;
    this.notificationType = BucketNotificationWorkerOptions2.toGrpcEvent(notificationType);
    this.notificationPrefixFilter = notificationPrefixFilter;
  }
  static toGrpcEvent(notificationType) {
    switch (notificationType) {
      case "write":
        return import_faas_pb3.BucketNotificationType.CREATED;
      case "delete":
        return import_faas_pb3.BucketNotificationType.DELETED;
      default:
        throw new Error(`notification type ${notificationType} is unsupported`);
    }
  }
};
var FileNotificationWorkerOptions = class extends BucketNotificationWorkerOptions2 {
...
var BucketNotification = class {
  constructor(bucket3, notificationType, notificationPrefixFilter, ...middleware) {
    this.faas = new Faas(
      new BucketNotificationWorkerOptions2(
        bucket3,
        notificationType,
...
var BucketResource = class extends SecureResource {
  ...
  on(notificationType, notificationPrefixFilter, ...middleware) {
    const notification2 = new BucketNotification(
      this.name,
      notificationType,
      notificationPrefixFilter,
      ...middleware
...
var bucket2 = make(BucketResource);
...
var Bucket2 = class {
   ...
   */
  on(notificationType, notificationPrefixFilter, ...middleware) {
    const notification2 = new FileNotification(
      this,
      notificationType,
      notificationPrefixFilter,
      ...middleware
...
var File = class {
  constructor(storage2, bucket3, name) {
    this.storage = storage2;
    this.bucket = bucket3;
    this.name = name;
  }
